...
const StoreDetails = () => {
  ...
  const fetchStores = async () => {
    try {
      setLoading(true);
      const res = await axios.get("https://gamezonecrm.onrender.com/api/admin/get-all-stores");
      setStores(res.data);
    } catch (err) {
  ...
  const handleDelete = async (number) => {
    ...
    try {
      await axios.delete(`https://gamezonecrm.onrender.com/api/admin/delete-store/${number}`);
